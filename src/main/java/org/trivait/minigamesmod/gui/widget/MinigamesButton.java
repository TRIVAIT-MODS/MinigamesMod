...
public class MinigamesButton extends TextIconButtonWidget.IconOnly {
    ...
    public MinigamesButton(int x, int y) {
        super(20, 20, Text.empty(), 16, 16, new ButtonTextures(MinigamesMod.CONFIG.staticIconButton ? DEFAULT_STATIC_TEXTURE : DEFAULT_TEXTURE, MinigamesMod.CONFIG.staticIconButton ? HOVER_STATIC_TEXTURE : HOVER_TEXTURE), button -> {

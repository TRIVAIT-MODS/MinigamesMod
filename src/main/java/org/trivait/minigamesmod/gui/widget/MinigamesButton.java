...
public class MinigamesButton extends SpriteIconButton.CenteredIcon {
    ...
    public MinigamesButton(int x, int y) {
        super(20, 20, net.minecraft.network.chat.Component.empty(), 16, 16, 0, 0, new WidgetSprites(MinigamesMod.CONFIG.staticIconButton ? DEFAULT_STATIC_TEXTURE : DEFAULT_TEXTURE, MinigamesMod.CONFIG.staticIconButton ? HOVER_STATIC_TEXTURE : HOVER_TEXTURE), button -> {

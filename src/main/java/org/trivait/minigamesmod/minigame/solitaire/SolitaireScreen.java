...
public final class SolitaireScreen extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawTexture(RenderLayer::getGuiTextured, SolitaireTextures.GUI_TEXTURE, boardLeft, boardTop, 0, 0, BOARD_WIDTH, BOARD_HEIGHT, BOARD_WIDTH, BOARD_HEIGHT);
    ...
    private void texture(DrawContext context, Identifier texture, int x, int y) {
        context.drawTexture(RenderLayer::getGuiTextured, texture, x, y, 0, 0, CARD_WIDTH, CARD_HEIGHT, CARD_WIDTH, CARD_HEIGHT);
    }

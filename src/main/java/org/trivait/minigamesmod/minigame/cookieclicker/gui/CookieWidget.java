...
public class CookieWidget extends ClickableWidget {
    ...
    protected void renderWidget(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawTexture(RenderPipelines.GUI_TEXTURED, COOKIE_TEXTURE, this.getX(), this.getY(), 0, 0, this.width, this.height, this.width, this.height);
    ...
    public class ClickEffect {
        ...
        public void render(DrawContext ctx) {
            ...
            ctx.drawTexture(RenderPipelines.GUI_TEXTURED, COOKIE_TEXTURE, x-(allWidth/2)+width, y-8, 0, 0, 16, 16, 16, 16, new Color(1, 1, 1, Math.max(0, alpha-=0.02f)).getRGB());

...
public class CookieClickerScreen extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        matrices.push();
        matrices.translate(gameX + (cookiePanelWidth / 2), gameY + 40, 0);
        ...
        if (CPS != 0) {
            matrices.push();
            matrices.translate(gameX + (cookiePanelWidth / 2), gameY + 58, 0);
    ...
    public void renderBackground(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawTexture(RenderLayer::getGuiTextured, BACKGROUND_TEXTURE, gameX + 1, gameY + 1, 0, 0, gameWidth - 1, gameHeight - 1, 32, 32);
